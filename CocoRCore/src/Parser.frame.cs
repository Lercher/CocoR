...
namespace CocoRCore
{
    ...
    public abstract class ErrorsBase : List<Error>
    {
        ...
        public void Add(int id, string level, int line, int col, string message)
        {
        ...
        public virtual void SemErr(int line, int col, string s, int id) => Add(SemErrOffset + id, ErrorLevel, line, col, s);
        public virtual void SemErr(int line, int col, string s) => SemErr(line, col, s, 0);
        public virtual void SemErr(string s) => SemErr(0, 0, s);
        public virtual void Warning(int line, int col, string s, int id) => Add(WarningOffset + id, WarningLevel, line, col, s);
        public virtual void Warning(int line, int col, string s) => Warning(line, col, s, 0);
        public virtual void Warning(string s) => Warning(0, 0, s);
    } // Errors
