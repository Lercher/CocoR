	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 3:
				...
				if (ch == '_' || ch >= 'a' && ch <= 'z' || ch == 223 || ch == 228 || ch == 246 || ch == 252) {AddCh(); goto case 3;}
			...
			case 13:
				...
				else if (ch <= 12 || ch >= 14 && ch <= '&' || ch >= '(' && ch <= 65535) {AddCh(); goto case 13;}
